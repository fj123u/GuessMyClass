...
# destination,text,width,height,pos,elevation,color, button=False, font=('font/Mighty Souly.ttf', 80), around=True
...
best_of_5 = Shape(None, 'Meilleur sur 5', current_w/4, 50, (10 +((current_w/b -15)/2) -(current_w/4)/2, 125), 0, (144, 140, 189), False, (resource_path('font/Mighty Souly.ttf'), 35))
best_of_10 = Shape(None, 'Meilleur out of 10', current_w/4, 50, (current_w/2 -current_w/8, 125), 0, (144, 140, 189), False, (resource_path('font/Mighty Souly.ttf'), 35))
best_of_20 = Shape(None, 'Meilleur out of 20', current_w/4, 50, (current_w -(current_w/b -15)/2 -5 -(current_w/4)/2, 125), 0, (144, 140, 189), False, (resource_path('font/Mighty Souly.ttf'), 35))
