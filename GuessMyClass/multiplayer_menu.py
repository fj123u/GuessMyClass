...
create_room_button = Shape('create_room_screen', 'Créer une partie', 500, 80, (current_w/2 - 250, current_h/2 - 60), 3, (104, 208, 229), True, (resource_path('GuessMyClass/font/MightySouly.ttf'), 50))

join_room_button = Shape('join_room_screen', 'Rejoindre une partie', 500, 80, (current_w/2 - 250, current_h/2 + 60), 3, (184, 180, 229), True, (resource_path('GuessMyClass/font/MightySouly.ttf'), 50))
